...
LocalUserObserver::LocalUserObserver(agora::rtc::ILocalUser *user) : local_user_(user)
{
  local_user_->registerLocalUserObserver(this);
}
...
void LocalUserObserver::onUserAudioTrackSubscribed(
...
void LocalUserObserver::onUserVideoTrackSubscribed(
...
void LocalUserObserver::onFirstRemoteVideoDecoded(agora::user_id_t userId, int width,
...
agora::rtc::MixerLayoutConfig LocalUserObserver::calculate_layout(int width, int height)
{
  agora::rtc::MixerLayoutConfig mixConfig;
  mixConfig.height = height;
  mixConfig.width = width;
...
void LocalUserObserver::onUserVideoTrackStateChanged(
...
void LocalUserObserver::onUserInfoUpdated(agora::user_id_t userId,
...
void LocalUserObserver::onUserAudioTrackStateChanged(
        agora::user_id_t userId, agora::agora_refptr<agora::rtc::IRemoteAudioTrack> audioTrack,
...
void LocalUserObserver::onIntraRequestReceived()
{
