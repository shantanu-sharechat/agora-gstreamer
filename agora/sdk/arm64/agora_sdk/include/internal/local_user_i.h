...
class ICapabilitesObserver {
 public:
  virtual void OnCapabilitesChanged(const capability::Capabilities& capabilities) {};
...
class ILocalUserEx : public rtc::ILocalUser {
 public:
  ...
  virtual void updateAppDefinedCapabilities(const capability::Capabilities& capabilities) = 0;
