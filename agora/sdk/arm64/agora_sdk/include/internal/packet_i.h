...
#include "AgoraBase.h"
#include "api/audio/audio_node_stat.h"
...
struct SAudioFrame : public SMediaFrame {
  ...
  uint8_t energy_;
  webrtc::AudioFrameHandleInfo handle_info_;
  SAudioFrame() : SMediaFrame(), codec_(0), ts_(0), vad_(0), internalFlags_(0), cc_type_(0), energy_(0) {}
};
...
struct SAudioPacket {
  ...
  webrtc::AudioFrameHandleInfo handle_timing_;
  SAudioPacket()
      : vad_(0),
        codec_(0),
        internalFlags_(0),
